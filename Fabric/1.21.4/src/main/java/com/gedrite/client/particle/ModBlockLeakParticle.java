...
//    public static SpriteBillboardParticle createDrippingDripstoneGedritedWater(SimpleParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
//        BlockPos pos = new BlockPos((int) x, (int) y, (int) z);
...
//    }
//
//    public static SpriteBillboardParticle createFallingDripstoneGedritedWater(SimpleParticleType type, ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
