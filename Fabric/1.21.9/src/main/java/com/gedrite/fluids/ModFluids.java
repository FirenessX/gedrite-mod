...
public class ModFluids {
    ...
    public static boolean isTouchingGedritedWater(Entity entity) {
    ...
    public static void decayEffect(Entity entity){
        if (entity instanceof LivingEntity livingEntity) {
            if (!livingEntity.hasStatusEffect(ModEffects.DECAY)) {
                livingEntity.addStatusEffect(new StatusEffectInstance(ModEffects.DECAY, 60, 0, false, true, true));
            }
        }
    }
