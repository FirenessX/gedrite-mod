...
public class ModItems {
    /// materials
    public static final Item GEDRITE_INGOT = registerItem("gedrite_ingot", new Item(new Item.Settings().food(ModFoodComponents.GEDRITE_INGOT, ModFoodComponents.GEDRITE_INGOT_EFFECT).trimMaterial(ModTrimMaterials.GEDRITE)
    ...
    /// tools
    public static final Item METAL_DETECTOR = registerItem("metal_detector", new MetalDetectorItem(new Item.Settings().maxDamage(69).useCooldown(4)
    ...
    /// weapon
    public static final Item GEDRITE_ARROW = registerItem("gedrite_arrow", new GedriteArrowItem(new Item.Settings()
            .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(Gedrite.MOD_ID, "gedrite_arrow")))));
