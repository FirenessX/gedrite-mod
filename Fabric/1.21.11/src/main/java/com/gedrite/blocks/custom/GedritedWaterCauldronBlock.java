...
public class GedritedWaterCauldronBlock extends AbstractCauldronBlock {
    ...
    @Override
    public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity, EntityCollisionHandler handler, boolean xz) {
        ModFluids.decayEffect(entity);
    }
