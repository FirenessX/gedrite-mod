...
//                world.playSoundClient((double)pos.getX() + 0.5, (double)pos.getY() + 0.5, (double)pos.getZ() + 0.5, SoundEvents.BLOCK_WATER_AMBIENT, SoundCategory.BLOCKS, random.nextFloat() * 0.25F + 0.75F, random.nextFloat() + 0.5F, false);
//            }
//        }
        if (random.nextInt(50) == 0) {
            world.addParticleClient(
                    ModParticleTypes.DECAY_PARTICLE, pos.getX() + 0.5, pos.getY() + 1.0, pos.getZ() + 0.0, Math.sin(world.getTime()), 1.0 , Math.sin(world.getTime()
            ));
        }
    }
