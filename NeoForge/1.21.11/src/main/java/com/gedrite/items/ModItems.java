...
public class ModItems {
    ...
    public static final DeferredItem<Item> RAW_GEDRITE = ITEMS.registerItem("raw_gedrite",
            Item::new, properties -> properties.setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, "raw_gedrite"))));
    ...
    public static final DeferredItem<Item> GEDRITED_COAL = ITEMS.registerItem("gedrited_coal",
            (properties) -> new FuelItem(properties, 3200), properties -> properties
                    .setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, "gedrited_coal"))));
    ...
    public static final DeferredItem<Item> GEDRITE_ARROW = ITEMS.registerItem("gedrite_arrow",
            GedriteArrowItem::new, properties -> properties.setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, "gedrite_arrow"))));
