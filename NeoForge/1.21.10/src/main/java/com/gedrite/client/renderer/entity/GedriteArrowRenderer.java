...
public class GedriteArrowRenderer extends ArrowRenderer<GedriteArrow, ArrowRenderState> {
    ...
    @Override
    protected @NotNull ResourceLocation getTextureLocation(@NotNull ArrowRenderState p_364566_) {
        return ResourceLocation.fromNamespaceAndPath(Gedrite.MOD_ID, "textures/entity/projectiles/gedrite_arrow.png");
    }
}