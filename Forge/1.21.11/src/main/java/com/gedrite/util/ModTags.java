...
public class ModTags {
    public static class Blocks{
        private static TagKey<Block> createTag(String name){
            return BlockTags.create(Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, name));
        }
    ...
    public static class Items{
        ...
        private static TagKey<Item> createTag(String name){
            return ItemTags.create(Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, name));
        }
    }
    ...
    public static class Fluids{
        ...
        private static TagKey<Fluid> createTag(String name) {
            return FluidTags.create(Identifier.fromNamespaceAndPath(Gedrite.MOD_ID, name));
        }
    }
...
//        return FluidTags.create(Identifier.fromNamespaceAndPath(id));
//    }
}
